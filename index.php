...
if(isset($_POST['name'])){
 ...
 $Servers = "localhost:3307";
 $uesrname = "root";
 $password = "";
 
 //create a database connection

$con = mysqli_connect($Servers, $uesrname, $password);
...
<body>
    <img class="image 1" src="image 1.jpeg" alt="IIT Kharagpur">
    <div class="container">
   ...
   <!--
    INSERT INTO `trip` (`sno`, `name`, `age`, `gender`, `email`, `phone`, `other`, `dt`)
     VALUES ('1', 'testName', '23', 'male', 'this@this.com', '9999999999', 'this is good value', current_timestamp());
   -->
